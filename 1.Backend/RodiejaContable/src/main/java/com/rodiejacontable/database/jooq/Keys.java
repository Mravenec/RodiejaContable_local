...
public class Keys {
    ...
    public static final UniqueKey<ModulosRecord> KEY_MODULOS_CLAVE = Internal.createUniqueKey(Modulos.MODULOS, DSL.name("KEY_modulos_clave"), new TableField[] { Modulos.MODULOS.CLAVE }, true);
    public static final UniqueKey<ModulosRecord> KEY_MODULOS_PRIMARY = Internal.createUniqueKey(Modulos.MODULOS, DSL.name("KEY_modulos_PRIMARY"), new TableField[] { Modulos.MODULOS.ID }, true);
    ...
    public static final UniqueKey<RolPermisosRecord> KEY_ROL_PERMISOS_PRIMARY = Internal.createUniqueKey(RolPermisos.ROL_PERMISOS, DSL.name("KEY_rol_permisos_PRIMARY"), new TableField[] { RolPermisos.ROL_PERMISOS.ID }, true);
    public static final UniqueKey<RolPermisosRecord> KEY_ROL_PERMISOS_UK_ROL_SUBMODULO = Internal.createUniqueKey(RolPermisos.ROL_PERMISOS, DSL.name("KEY_rol_permisos_uk_rol_submodulo"), new TableField[] { RolPermisos.ROL_PERMISOS.ROL_ID, RolPermisos.ROL_PERMISOS.SUBMODULO_ID }, true);
    ...
    public static final UniqueKey<SubmodulosRecord> KEY_SUBMODULOS_CLAVE = Internal.createUniqueKey(Submodulos.SUBMODULOS, DSL.name("KEY_submodulos_clave"), new TableField[] { Submodulos.SUBMODULOS.CLAVE }, true);
    public static final UniqueKey<SubmodulosRecord> KEY_SUBMODULOS_PRIMARY = Internal.createUniqueKey(Submodulos.SUBMODULOS, DSL.name("KEY_submodulos_PRIMARY"), new TableField[] { Submodulos.SUBMODULOS.ID }, true);
    ...
    public static final ForeignKey<InventarioRepuestosRecord, GeneracionesRecord> INVENTARIO_REPUESTOS_IBFK_3 = Internal.createForeignKey(InventarioRepuestos.INVENTARIO_REPUESTOS, DSL.name("inventario_repuestos_ibfk_3"), new TableField[] { InventarioRepuestos.INVENTARIO_REPUESTOS.GENERACION_ID }, Keys.KEY_GENERACIONES_PRIMARY, new TableField[] { Generaciones.GENERACIONES.ID }, true);
    ...
    public static final ForeignKey<RolPermisosRecord, RolesRecord> ROL_PERMISOS_IBFK_1 = Internal.createForeignKey(RolPermisos.ROL_PERMISOS, DSL.name("rol_permisos_ibfk_1"), new TableField[] { RolPermisos.ROL_PERMISOS.ROL_ID }, Keys.KEY_ROLES_PRIMARY, new TableField[] { Roles.ROLES.ID }, true);
    public static final ForeignKey<RolPermisosRecord, SubmodulosRecord> ROL_PERMISOS_IBFK_2 = Internal.createForeignKey(RolPermisos.ROL_PERMISOS, DSL.name("rol_permisos_ibfk_2"), new TableField[] { RolPermisos.ROL_PERMISOS.SUBMODULO_ID }, Keys.KEY_SUBMODULOS_PRIMARY, new TableField[] { Submodulos.SUBMODULOS.ID }, true);
    public static final ForeignKey<SubmodulosRecord, ModulosRecord> SUBMODULOS_IBFK_1 = Internal.createForeignKey(Submodulos.SUBMODULOS, DSL.name("submodulos_ibfk_1"), new TableField[] { Submodulos.SUBMODULOS.MODULO_ID }, Keys.KEY_MODULOS_PRIMARY, new TableField[] { Modulos.MODULOS.ID }, true);
