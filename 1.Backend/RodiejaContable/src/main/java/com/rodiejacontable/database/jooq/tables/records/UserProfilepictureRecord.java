...
public class UserProfilepictureRecord extends UpdatableRecordImpl<UserProfilepictureRecord> implements Record2<Integer, byte[]> {
     ...
     */
    public UserProfilepictureRecord setUserId(Integer value) {
        set(0, value);
        return this;
    }
     ...
     */
    public UserProfilepictureRecord setProfilePicture(byte[] value) {
        set(1, value);
        return this;
    }
     ...
     * Create a detached, initialised UserProfilepictureRecord
     */
    public UserProfilepictureRecord(com.rodiejacontable.database.jooq.tables.pojos.UserProfilepicture value) {
        super(UserProfilepicture.USER_PROFILEPICTURE);
