...
public class DefaultCatalog extends CatalogImpl {
    ...
    /**
     * The schema <code>sistema_vehicular</code>.
     */
    public final SistemaVehicular SISTEMA_VEHICULAR = SistemaVehicular.SISTEMA_VEHICULAR;
    ...
    public final List<Schema> getSchemas() {
        return Arrays.asList(
            SistemaVehicular.SISTEMA_VEHICULAR
        );
    }
