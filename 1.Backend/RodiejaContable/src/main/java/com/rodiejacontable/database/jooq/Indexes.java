...
public class Indexes {
    ...
    public static final Index INVENTARIO_REPUESTOS_IDX_ACTIVO = Internal.createIndex(DSL.name("idx_activo"), InventarioRepuestos.INVENTARIO_REPUESTOS, new OrderField[] { InventarioRepuestos.INVENTARIO_REPUESTOS.ACTIVO }, false);
