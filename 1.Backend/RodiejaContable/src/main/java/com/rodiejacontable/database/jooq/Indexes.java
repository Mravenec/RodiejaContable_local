...
public class Indexes {
    ...
    public static final Index AUDATEX_PEDIDOS_IDX_AUDATEX_PEDIDOS_COTIZACION = Internal.createIndex(DSL.name("idx_audatex_pedidos_cotizacion"), AudatexPedidos.AUDATEX_PEDIDOS, new OrderField[] { AudatexPedidos.AUDATEX_PEDIDOS.COTIZACION_ID }, false);
    public static final Index AUDATEX_PEDIDOS_IDX_AUDATEX_PEDIDOS_ESTADO = Internal.createIndex(DSL.name("idx_audatex_pedidos_estado"), AudatexPedidos.AUDATEX_PEDIDOS, new OrderField[] { AudatexPedidos.AUDATEX_PEDIDOS.ESTADO }, false);
    public static final Index AUDATEX_PEDIDOS_IDX_AUDATEX_PEDIDOS_WAN = Internal.createIndex(DSL.name("idx_audatex_pedidos_wan"), AudatexPedidos.AUDATEX_PEDIDOS, new OrderField[] { AudatexPedidos.AUDATEX_PEDIDOS.WAN }, false);
    ...
    public static final Index INVENTARIO_REPUESTOS_IDX_GENERACION = Internal.createIndex(DSL.name("idx_generacion"), InventarioRepuestos.INVENTARIO_REPUESTOS, new OrderField[] { InventarioRepuestos.INVENTARIO_REPUESTOS.GENERACION_ID }, false);
    ...
    public static final Index INVENTARIO_REPUESTOS_IDX_PARTE_VEHICULO = Internal.createIndex(DSL.name("idx_parte_vehiculo"), InventarioRepuestos.INVENTARIO_REPUESTOS, new OrderField[] { InventarioRepuestos.INVENTARIO_REPUESTOS.PARTE_VEHICULO_ID }, false);
